...
const NoRequest = () => {
  return (
    <div className="w-full bg-white dark:bg-[#0B0F19] border border-dashed border-slate-300 dark:border-slate-800 rounded-3xl p-6 md:p-10 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 min-h-[280px] transition-colors duration-300">
