...
const RequestCard = ({ row, setRequests }) => {
  ...
  return (
    <div className="bg-[#111827] border border-slate-900 rounded-3xl overflow-hidden shadow-xl hover:border-slate-800 transition-all duration-300 flex flex-col justify-between group">
      ...
      <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
        <div>
          ...
          {row.message && (
            <p className="text-xs text-slate-400 italic bg-[#0B0F19]/60 p-2.5 rounded-xl border border-slate-900 mt-4 line-clamp-2">
              {row.message}
            </p>
          )}
        </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 py-2 rounded-xl border border-rose-950/40 bg-rose-950/10 text-xs font-bold text-rose-500 hover:bg-rose-950/30 transition active:scale-95"
          >
