...
const NoPetList = () => {
  return (
    <div className="w-full bg-white dark:bg-[#0B0F19] border border-dashed border-slate-200 dark:border-slate-800 rounded-3xl p-6 md:p-10 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 min-h-[280px] transition-colors duration-300">
      ...
      <div className="relative w-48 h-36 md:w-56 md:h-40 flex items-center justify-center">
        ...
        <svg
          className="w-24 h-24 md:w-32 md:h-32 text-slate-300 dark:text-slate-700 opacity-80 transition-colors duration-300"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          strokeWidth="1.5"
